...
/*
    ...
    4. Corrupt an object on the S3 cloud target by appending data to the end of the file.
...
public class GetFromS3NativeAppendObjectTest {
    private static final Logger LOG = Logger.getLogger(GetFromS3NativeAppendObjectTest.class);
    ...
    public void testS3CloudCorruption() throws IOException {
        LOG.info("Starting test: GetFromS3AppendObjectTest");
        try {
            ...
            addJobName(client, "GetFromS3AppendObjectTest", currentJobId);
            ...
            increaseS3ObjectSizeEnd(localStackClient, bucketName);
            ...
            addJobName(client, "ReadFromS3Native", readJobId);
