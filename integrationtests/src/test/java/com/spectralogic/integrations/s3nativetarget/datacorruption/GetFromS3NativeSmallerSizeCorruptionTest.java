...
import static com.spectralogic.integrations.Ds3ReplicationUtils.clearS3Targets;
...
//https://jira.spectralogic.com/browse/EMPROD-7016?filter=-1
/*
    Test steps:
    ...
    4. Corrupt an object on the S3 cloud target reducing the size of the file.
...
public class GetFromS3NativeSmallerSizeCorruptionTest {
    private static final Logger LOG = Logger.getLogger(GetFromS3NativeSmallerSizeCorruptionTest.class);
    ...
    public void testS3CloudCorruption()  {
        LOG.info("Starting test: GetFromS3NativeSmallerSizeCorruptionTest");
        try {
            ...
            addJobName(client, "GetFromS3NativeSmallerSizeCorruptionTest", currentJobId);
            ...
            reduceSizeS3Object(localStackClient, bucketName);
