...
public class GetFromS3SmallerSizeCorruptionTest {
    private static final Logger LOG = Logger.getLogger(GetFromS3SmallerSizeCorruptionTest.class);
    ...
    public void testS3CloudCorruption() throws IOException, InterruptedException {
        LOG.info("Starting test: GetFromS3SmallerSizeCorruptionTest");
        try {
            ...
            addJobName(client, "GetFromS3SmallerSizeCorruptionTest", currentJobId);
            ...
            addJobName(client, "ReadS3", readJobId);
            try{
