...
public class GetFromS3TargetSameSizeCorruptionTest {
    private static final Logger LOG = Logger.getLogger(GetFromS3TargetSameSizeCorruptionTest.class);
    ...
    public void testS3CloudCorruption() throws IOException, InterruptedException {
        LOG.info("Starting test: GetFromS3TargetSameSizeCorruptionTest");
        try {
            ...
            addJobName(client, "GetFromS3TargetSameSizeCorruptionTest", currentJobId);
