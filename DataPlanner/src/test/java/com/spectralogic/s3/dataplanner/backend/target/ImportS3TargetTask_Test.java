...
public final class ImportS3TargetTask_Test 
{
    @Test
    public void testImportDoesSoWhenSingleSegment()
    {
        ...
        mockDaoDriver.createImportS3TargetDirective( 
        ...
        MockS3Connection connection =
                new MockS3Connection( dbSupport.getServiceManager(), segments );
        connection.expectTakeOwnershipCalls();
        ImportS3TargetTask task = new TargetTaskBuilder(dbSupport.getServiceManager())
                .withS3ConnectionFactory(connection.toConnectionFactory()).buildImportS3TargetTask(
        ...
        final Object actual5 = dbSupport.getServiceManager().getRetriever( S3TargetFailure.class ).getCount();
        ...
        final Object actual3 = dbSupport.getServiceManager().getRetriever( BlobS3Target.class ).getCount();
         ...
         */
        connection = new MockS3Connection( dbSupport.getServiceManager(), segments );
        connection.expectTakeOwnershipCalls();
        mockDaoDriver.createImportS3TargetDirective( 
                target.getId(), user.getId(), dataPolicy.getId(), "blah" );
        task = new TargetTaskBuilder(dbSupport.getServiceManager())
                .withS3ConnectionFactory(connection.toConnectionFactory())
                .buildImportS3TargetTask(
                    BlobStoreTaskPriority.NORMAL,
                    target.getId() );
        task.prepareForExecutionIfPossible();
        ...
        final Object actual2 = dbSupport.getServiceManager().getRetriever( S3TargetFailure.class ).getCount();
        ...
        final Object actual = dbSupport.getServiceManager().getRetriever( BlobS3Target.class ).getCount();
    ...
    public void testImportDoesSoWhenMultipleSegments()
    {
        ...
        final List< BucketOnPublicCloud > segments = 
                MockS3Connection.createDiscoverableSegments( dbSupport, target, 5 );
        whackAllObjects( dbSupport );
        MockS3Connection connection =
                new MockS3Connection( dbSupport.getServiceManager(), segments );
        connection.expectTakeOwnershipCalls();
    ...
    public void testImportWhenTakeOwnershipFailsGeneratesFailure()
    {
        ...
        final MockS3Connection connection =
                new MockS3Connection( dbSupport.getServiceManager(), segments );
        final ImportS3TargetTask task = new TargetTaskBuilder(dbSupport.getServiceManager())
                .withS3ConnectionFactory(connection.toConnectionFactory()).buildImportS3TargetTask(
                        BlobStoreTaskPriority.NORMAL,
                        target.getId() );
        task.prepareForExecutionIfPossible();
        ...
        final Object actual1 = dbSupport.getServiceManager().getRetriever( ImportS3TargetDirective.class ).getCount();
    ...
    public void testImportWhenNoDirectiveToDoSoGeneratesFailure()
    {
        ...
        final Object actual3 = dbSupport.getServiceManager().getRetriever( S3TargetFailure.class ).getCount();
        assertEquals((Object) 1, actual3, "Shoulda been a failures.");
        final Object actual2 = dbSupport.getServiceManager().getRetriever( ImportS3TargetDirective.class ).getCount();
    ...
    private int verifyAllImportedCorrectly( 
            ...
            final List< BucketOnPublicCloud > segments )
    {
        final Object actual = dbSupport.getServiceManager().getRetriever( ImportS3TargetDirective.class ).getCount();
        assertEquals( 0, actual, "Shoulda whacked import directive.");
