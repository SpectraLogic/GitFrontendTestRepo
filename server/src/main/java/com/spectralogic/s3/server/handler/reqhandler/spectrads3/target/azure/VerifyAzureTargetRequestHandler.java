...
public final class VerifyAzureTargetRequestHandler extends BaseRequestHandler
{
    public VerifyAzureTargetRequestHandler()
    {
    ...
    {
        final BeansRetriever< AzureTarget > retriever =
                params.getServiceManager().getRetriever( AzureTarget.class );
        final UUID targetId = request.getRestRequest().getBean( retriever ).getId();
        
        params.getTargetResource().verifyAzureTarget( 
                targetId,
