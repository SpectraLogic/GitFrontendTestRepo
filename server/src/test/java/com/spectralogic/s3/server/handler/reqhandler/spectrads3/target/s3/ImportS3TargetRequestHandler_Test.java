...
public final class ImportS3TargetRequestHandler_Test 
{
    @Test
    public void testImportWithRequiredParamsOnlyCallsDataPlanner()
    {
        ...
        final UUID targetId = mockDaoDriver.createS3Target( null ).getId();
        ...
        MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.PUT, 
                "_rest_/" + RestDomainType.S3_TARGET + "/" + targetId.toString() )
        ...
        assertEquals(
                targetId,
                ( (ImportPublicCloudTargetDirective< ? >)
                        support.getTargetInterfaceBtih().getMethodInvokeData().get( 0 ).getArgs().get( 0 ) )
                        .getTargetId(),
                "Shoulda formatted only the expected target id."
                );
    }
