...
public final class CreateAzureTargetReadPreferenceRequestHandler_Test 
{
    @Test
    public void testCreateDoesNotDelegateToDataPlanner()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver(
                ...
                RequestType.POST, 
                "_rest_/" + RestDomainType.AZURE_TARGET_READ_PREFERENCE )
        ...
        mockDaoDriver.attainOneAndOnly( AzureTargetReadPreference.class );
