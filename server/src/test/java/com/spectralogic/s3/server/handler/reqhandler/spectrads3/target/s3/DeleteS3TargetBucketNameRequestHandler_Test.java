...
public final class DeleteS3TargetBucketNameRequestHandler_Test 
{
    @Test
    public void testDeleteDoesNotDelegateToDataPlanner()
    {
        ...
        final S3TargetBucketName bn = mockDaoDriver.createS3TargetBucketName( 
                null, null, null );
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver(
                ...
                RequestType.DELETE, 
                "_rest_/" + RestDomainType.S3_TARGET_BUCKET_NAME + "/" + bn.getId() );
        driver.run();
