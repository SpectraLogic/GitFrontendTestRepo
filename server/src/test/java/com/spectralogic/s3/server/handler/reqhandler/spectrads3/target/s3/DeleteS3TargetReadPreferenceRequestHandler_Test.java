...
public final class DeleteS3TargetReadPreferenceRequestHandler_Test 
{
    @Test
    public void testDeleteDoesNotDelegateToDataPlanner()
    {
        ...
        final S3TargetReadPreference rp = mockDaoDriver.createS3TargetReadPreference(
                null, null, null );
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver(
                ...
                RequestType.DELETE, 
                "_rest_/" + RestDomainType.S3_TARGET_READ_PREFERENCE + "/" + rp.getId() );
        driver.run();
