...
public final class CreateDs3TargetReadPreferenceRequestHandler_Test
{
    @Test
    public void testCreateDoesNotDelegateToDataPlanner()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver(
                ...
                RequestType.POST, 
                "_rest_/" + RestDomainType.DS3_TARGET_READ_PREFERENCE )
        ...
        mockDaoDriver.attainOneAndOnly( Ds3TargetReadPreference.class );
        assertEquals(
                0,
