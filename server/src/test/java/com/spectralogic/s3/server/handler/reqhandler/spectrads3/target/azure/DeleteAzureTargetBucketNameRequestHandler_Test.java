...
public final class DeleteAzureTargetBucketNameRequestHandler_Test 
{
    @Test
    public void testDeleteDoesNotDelegateToDataPlanner()
    {
        ...
        final AzureTargetBucketName bn = mockDaoDriver.createAzureTargetBucketName( 
                null, null, null );
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver(
                ...
                RequestType.DELETE, 
                "_rest_/" + RestDomainType.AZURE_TARGET_BUCKET_NAME + "/" + bn.getId() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 204 );
        
        assertNull(
                mockDaoDriver.retrieve( bn ),
