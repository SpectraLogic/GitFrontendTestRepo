...
public final class GetBlobsOnS3TargetRequestHandler_Test 
{
    @Test
    public void testGetBlobsOnS3TargetReturnsOnlyThoseBlobsOnThatS3Target()
    {
        final MockHttpRequestSupport support = new MockHttpRequestSupport();
        
        final MockDaoDriver mockDaoDriver = new MockDaoDriver( support.getDatabaseSupport() );
        final S3Target s3Obj1 = mockDaoDriver.createS3Target( "s3Obj1" );
        final S3Target s3Obj2 = mockDaoDriver.createS3Target( "s3Obj2" );
        ...
        mockDaoDriver.putBlobOnS3Target( s3Obj1.getId(), blob1.getId() );
        mockDaoDriver.putBlobOnS3Target( s3Obj1.getId(), blob2.getId() );
        mockDaoDriver.putBlobOnS3Target( s3Obj2.getId(), blob3.getId() );
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.GET, 
                "_rest_/" + RestDomainType.S3_TARGET.toString() + "/" + s3Obj1.getId().toString() )
