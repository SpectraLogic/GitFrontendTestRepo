...
public class SuspectS3BlobReadTestRunner extends BaseTestRunner {
    private final static Logger LOG = Logger.getLogger( SuspectS3BlobReadTestRunner.class );
    private final static int INFINITE_RETRY_THREAD_TIMEOUT_FOR_SUCCESS = 60;
    private ConnectionCreator<?> cc;
    public SuspectS3BlobReadTestRunner(
            ...
            final PublicCloudConnection connection ) throws Exception
    {
            ...
            blobS3Target.setBlobId( blobs.get(0).getId() );
