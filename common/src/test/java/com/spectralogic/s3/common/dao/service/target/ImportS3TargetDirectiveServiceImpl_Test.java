...
public final class ImportS3TargetDirectiveServiceImpl_Test 
{
    @Test
    public void testDeleteByBeanPropertyDoesSo()
    {
        ...
        final ImportS3TargetDirectiveService service =
                dbSupport.getServiceManager().getService( ImportS3TargetDirectiveService.class );
